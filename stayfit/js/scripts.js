...
function print_ideal()
{
	...
	if(age >= 0 && age < 2)
		{
			const res = '<div style="margin-top:20px"></div><h2 style="margin-bottom:10px;"> Your ideal weight and height should lie between: </h2><span>3.3-11.7kg &amp 49.2-85.1cm</span><div style="margin-top:10px; margin-bottom: 5px;">Read below to know how you can stay fit! </div><img id="image" src="https://cdn.cdnparenting.com/articles/2018/09/11-Physical-Developmental-Milestones-for-Toddlers-Ages-1-2-and-Activities-to-Boost-Them.jpg " width=100%>';
		...
		{
			const res = '<div style="margin-top:20px"></div><h2 style="margin-bottom:10px;"> Your ideal weight and height should be: </h2><span>12-41.5kg &amp 85.5-149.8cm</span><div style="margin-top:10px; margin-bottom: 5px;">Read below to know how you can stay fit! </div><img id="image" src=" https://labtestsonline.org/sites/aacc-lto.us/files/inline-images/kids%201000x270_people_022.jpg " width=100%>';
			document.getElementById("result").innerHTML = res;
		...
		{
			const res = '<div style="margin-top:20px"></div><h2 style="margin-bottom:10px;"> Your ideal weight and height should be: </h2><span>45.8-58kg &amp 156.7-163.3cm</span><div style="margin-top:10px; margin-bottom: 5px;">Read below to know how you can stay fit! </div><img id="image" src=" https://i2.wp.com/www.director.co.uk/wp-content/uploads/2016/07/18-year-old-selves-receieve-business-advice.jpg?fit=1000%2C500&ssl=1 " width=100%>';
			document.getElementById("result").innerHTML = res;
		...
		{
			const res = '<div style="margin-top:20px"></div><h2 style="margin-bottom:10px;"> Your ideal weight and height should be: </h2><span> above 58kg &amp above 163.3cm</span><div style="margin-top:10px; margin-bottom: 5px;">Read below to know how you can stay fit! </div><img id="image" src=" https://fitnesstogether.com/files/shared/Middle%20aged%20couple%20with%20bikes.jpg" width=100%>';
			document.getElementById("result").innerHTML = res;
